...
class Connection{
    ...
    public function connection(){
        try {
            $this->connection =new \PDO("mysql:host=mysql.primordium.com.br;dbname=primordium;charset=utf8","primordium","!@#AKJJYGLC");            $this->connection->setAttribute(\PDO::ATTR_ERRMODE, \PDO::ERRMODE_EXCEPTION);
