...
<form class="form-horizontal" method="post" action="../controller/controllerUpdateCliente.php">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input id="textinput" name="nome" type="text" placeholder="insira seu nome completo" value="<?php echo $nome ?>" class="form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input id="textinput" name="celular" type="tel" placeholder="" value="<?php echo $celular ?>" class="form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input id="textinput" name="cpf" type="text" placeholder="" value="<?php echo $cnpj ?>" class="form-control input-md" required="">
