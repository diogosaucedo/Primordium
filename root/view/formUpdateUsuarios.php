...
<form class="form-horizontal" method="post" action="../controller/controllerUpdateUsuario.php">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input id="textinput" name="email" type="text" placeholder="" value="<?php echo $email ?>" class="form-control input-md" required="">
